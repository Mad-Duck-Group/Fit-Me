...
namespace BetterFolders
{
    ...
    public static class FolderColors
    {
        ...
        private const string settingsPath = "Assets/Plugins/BetterFolders/Resources/FolderColorSettings.asset";
        ...
        private static void LoadSettings()
        {
            ...
            if (settings == null)
            {
                if (!AssetDatabase.IsValidFolder("Assets/Plugins/BetterFolders/Resources"))
                {
                    Directory.CreateDirectory("Assets/Plugins/BetterFolders");
                    AssetDatabase.CreateFolder("Assets/Plugins/BetterFolders", "Resources");
                ...
                EditorApplication.delayCall += () =>
                {
                    ...
                    {
                    "Assets/Plugins/BetterFolders/Resources/Presets/DefaultFolderRules.json",
                    };
